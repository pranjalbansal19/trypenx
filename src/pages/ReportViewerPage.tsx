	...
	return (
		<div className="container-max py-12 space-y-6">
			<div className="flex items-center justify-between">
				<h2 className="text-2xl font-semibold">Report — {domain}</h2>
				{data && (
					<PDFDownloadLink
			...
			<div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
				<div className="lg:col-span-2 glass rounded-xl p-6 space-y-4">
					...
					<p className="text-sm text-white/80">This section summarizes overall risk posture, major findings, and strategic recommendations for leadership review.</p>
					<h3 className="font-semibold pt-4">Vulnerability Table</h3>
					<p className="text-sm text-white/80">A full, filterable table is included in the dashboard. Export provides CVE references and CWE mappings.</p>
					<h3 className="font-semibold pt-4">Fix Recommendations</h3>
					<p className="text-sm text-white/80">Each issue includes prioritized steps, owner suggestions, and validation checks post-remediation.</p>
				</div>
				<div className="glass rounded-xl p-6 space-y-4">
					<h3 className="font-semibold">Severity Matrix</h3>
					<div className="grid grid-cols-2 gap-2 text-xs">
						<div className="rounded-md bg-red-500/20 p-3">Critical</div>
						<div className="rounded-md bg-orange-500/20 p-3">High</div>
						<div className="rounded-md bg-yellow-500/20 p-3">Medium</div>
						<div className="rounded-md bg-emerald-500/20 p-3">Low</div>
					</div>
